...
def main():
    ...
    base_path = "/home/strpicket/Videos/Signs"
    predefined_videos = {
        'stop': f"{base_path}/Stop (1).mov",
        'road_work': f"{base_path}/Road_work.mov", 
        'give_way': f"{base_path}/Give_way.mov",
        'turn_left': f"{base_path}/Turn_left.mov",
        'go_straight': f"{base_path}/Go_straight.mov",
        'turn_right': f"{base_path}/Turn_right.mov"
    }
